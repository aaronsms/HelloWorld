...
class Dialog extends StatelessWidget {
  ...
  /// The amount of padding added to [MediaQuery.of(context).viewInsets] on the outside
  /// of the dialog. This defines the minimum space between the screen's edges
  /// and the dialog.
  ///
  /// Defaults to `EdgeInsets.symmetric(horizontal: 0.0, vertical: 24.0)`.
  /// {@endtemplate}
...
class AlertDialog extends StatelessWidget {
  ...
  /// AlertDialog(
  ///   title: Text('Title'),
  ///   content: Container(width: 400, height: 200, color: Colors.green),
  ///   actions: <Widget>[
